...
import { p as outlinedPlayArrow, v as outlinedMenu, Q as QTooltip, c as outlinedFavoriteBorder, w as outlinedMoreHoriz, x as outlinedDescription, y as outlinedEditNote } from "./QTooltip.d71d984c.js";
import { a as QItemSection, Q as QItem, b as QItemLabel } from "./QItem.84972d21.js";
import { Q as QList } from "./QList.3d125a0e.js";
import { i as useVirtualScrollProps, j as useVirtualScroll, k as commonVirtPropsList, Q as QSelect, l as QChip, g as QMenu } from "./QSelect.3a992706.js";
import { E as defineComponent, S as useRouter, G as openBlock, U as createElementBlock, J as createVNode, T as unref, R as createBaseVNode, H as createBlock, a5 as createCommentVNode, $ as toDisplayString, X as Fragment, Y as renderList, V as QSeparator, _ as _export_sfc, bq as pushScopeId, br as popScopeId, c as createComponent, m as h, q as hSlot, a1 as hUniqueSlot, Z as QIcon, t as getCurrentInstance, g as computed, a as useDarkProps, d as useDark, r as ref, w as watch, ae as onBeforeMount, o as onMounted, aT as onActivated, aS as onDeactivated, k as onBeforeUnmount, as as getScrollTarget, ar as listenOpts, A as hMergeSlot, aA as useSizeProps, aB as useSize, bs as vmHasRouter, bt as History, a6 as isNumber, bu as isDate, a7 as isObject, n as nextTick, bv as injectMultipleProps, bw as QCheckbox, ba as injectProp, N as QBtn, i as inject, I as withCtx, W as createTextVNode, bx as QueueAddMode, l as withDirectives, ad as Duration, af as resolveComponent, K as QCardSection, b7 as QAvatar, M as QCardActions, O as QCard, Q as QDialog, F as useQuasar, bm as useLoadableController, bl as AlbumApi } from "./index.61faeb9b.js";
import { Q as QPage } from "./QPage.6e52f11c.js";
import { C as ClosePopup } from "./ClosePopup.d07ab8a0.js";
import { Q as QImg } from "./QImg.749885b5.js";
import { D as DataSourceButton, U as UrlUtils } from "./DataSourceButton.e79770fe.js";
import { Q as QBtnDropdown, d as matFileDownload, e as matContentCopy } from "./QBtnDropdown.ab111045.js";
...
var AlbumInfoSection = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-74c424d0"], ["__file", "AlbumInfoSection.vue"]]);
...
const _hoisted_1$2 = { class: "track-list-table row full-width q-px-none q-pt-lg" };
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    ...
    const searchOnYouTube = (track) => {
      var _a, _b;
      const albumObject = props.tracks.keys().next().value;
      const circleName = albumObject.albumArtist[0].name;
      UrlUtils.openUrlInNewTab(
        UrlUtils.constructYouTubeSearchQuery(
          `"${(_a = track == null ? void 0 : track.name) == null ? void 0 : _a._default}" ${(_b = albumObject.name) == null ? void 0 : _b._default} ${circleName}`
        )
      );
    };
                  ...
                  default: withCtx(() => [
                    createVNode(QList, { style: { "min-width": "150px" } }, {
                      default: withCtx(() => [
                        ...
                        withDirectives((openBlock(), createBlock(QItem, {
                          clickable: "",
                          onClick: ($event) => searchOnYouTube(props2.row)
                        }, {
                          default: withCtx(() => [
                            createVNode(QItemSection, null, {
                              default: withCtx(() => [
